...
|---------|-------------|
| [**vecmap**](https://github.com/theryeguy92/vecmap) | GPU-accelerated document similarity engine with graph-based relationship mapping — 553M pairs/sec on RTX 5080|
